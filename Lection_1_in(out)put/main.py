...
# print(f"Sum of tables for 3 classes: {(first_class_pupils + 1 ) // 2 + (second_class_pupils + 1 ) // 2 + (third_class_pupils + 1) // 2}")

# third option

# print(
#     first_class_pupils % 2
#     + first_class_pupils // 2
#     + second_class_pupils % 2
#     + second_class_pupils // 2
#     + third_class_pupils % 2
#     + third_class_pupils // 2
# )
